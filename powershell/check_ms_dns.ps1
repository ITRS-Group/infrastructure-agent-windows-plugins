...
$check = [Plugin]::new("check_ms_dns", "", "Copyright (C) 2003-2026 ITRS Group Ltd. All rights reserved. This plugin monitors the stats for your Microsoft DNS Server.", "Plugin Options:`n
        -m Metric to Monitor
        -w Warning Threshold
