...
$check = [Plugin]::new("check_ms_sql_performance", "", "Copyright (C) 2003-2024 ITRS Group Ltd. All rights reserved. This plugin monitors the stats for your Microsoft SQL Performance Metrics.", "Plugin Options:`n
        -m Metric to Monitor
        -w Warning Threshold
