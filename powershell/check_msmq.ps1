...
$check = [Plugin]::new("check_msmq", "", "Copyright (C) 2003-2024 ITRS Group Ltd. All rights reserved. This plugin monitors the stats for your Microsoft Message Queue.", "Plugin Options:`n
        -m Metric to Monitor
        -w Warning Threshold
