...
$check = [Plugin]::new("check_windows_base", "", "Copyright (C) 2003-2024 ITRS Group Ltd. All rights reserved. This plugin monitors the stats for your Windows system.", "Plugin Options:`n
        -m Metric to Monitor
        -w Warning Threshold
